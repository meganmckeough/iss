	...
	render() {
		return (
			<div className={"sidebar " + this.props.className}>
				...
				<p className="about">This site was built by <a href="https://www.linkedin.com/in/megan-mckeough/" target="_blank">me</a>, Megan McKeough, with React.js, <a href="https://open-notify.org/" target="_blank">Open Notify</a>, <a href="https://www.geonames.org/" target="_blank">GeoNames</a>, and <a href="https://countryflags.io/" target="_blank">CountryFlags.io</a> APIs, and a love of space (the final frontier).</p>
